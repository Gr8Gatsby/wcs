...
let EmojiSlider = class EmojiSlider extends LitElement {
  ...
  setValue (x) {
    ...
    const pct = Math.max (
      0,
      Math.min (rect.width ? (x - rect.left) / rect.width : 0, 1)
    );
  ...
  updateValue () {
    ...
    if (this.cursor) this.cursor.style.left = offset;
    if (this.valueBar) {
...
__decorate (
  [query ('#bar'), __metadata ('design:type', HTMLDivElement)],
  EmojiSlider.prototype,
  'trackBar',
  void 0
);
__decorate (
  [query ('#cursor'), __metadata ('design:type', HTMLDivElement)],
  EmojiSlider.prototype,
  'cursor',
  void 0
);
__decorate (
  [query ('#valueBar'), __metadata ('design:type', HTMLDivElement)],
  EmojiSlider.prototype,
  'valueBar',
  void 0
);
EmojiSlider = __decorate ([customElement ('emoji-slider')], EmojiSlider);
